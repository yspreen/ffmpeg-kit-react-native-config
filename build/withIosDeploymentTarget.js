...
exports.withIosDeploymentTarget = void 0;
...
function updateDeploymentTargetXcodeProject(project, deploymentTarget) {
  ...
  for (const { buildSettings } of Object.values(configurations ?? {})) {
    ...
    if (
      ...
      semver_1.default.lt(
        toSemVer(currDeploymentTarget),
        toSemVer(deploymentTarget)
      )
    ) {
...
function toSemVer(version) {
  return (
    semver_1.default.coerce(version) ?? new semver_1.default.SemVer("0.0.0")
  );
}
