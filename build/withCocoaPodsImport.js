...
function addCocoaPodsImport(src) {
  return (0, generateCode_1.mergeContents)({
    ...
    src,
    newSrc: `  pod 'ffmpeg-kit-react-native', :subspecs => podfile_properties['ffmpeg-kit-react-native.subspecs'] || [], :podspec => File.join(File.dirname(\`node --print "require.resolve('@spreen/ffmpeg-kit-react-native/package.json')"\`), "ffmpeg-kit-react-native.podspec")`,
